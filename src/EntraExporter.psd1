@{
    ...
    PrivateData          = @{
        ...
        PSData = @{
            ...
            Tags         = 'Microsoft', 'Identity', 'Azure', 'Entra', 'AzureAD', 'AAD', 'Export', 'Backup', 'DR', 'Windows', 'Linux', 'macOS'
            ...
            ReleaseNotes = 'https://github.com/microsoft/EntraExporter/releases'
    ...
    HelpInfoURI          = 'https://github.com/microsoft/EntraExporter/issues'
